...
public class RequestValidationException extends BasicException {
    @Override
    ...
    public RequestValidationException(ErrorCode code) {
        super(code);
    }

    public RequestValidationException(ErrorCode code, BindingResult bindingResult) {
